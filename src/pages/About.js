  ...
  return (
    <div className='about' style={colorStyle}>
      ...
      <div className='section about-me'>
        ...
        <p className='objective'>Motivated and results-driven professional <span>transitioning</span> from a successful career in <span>sales to frontend development</span>. Passionate about creating intuitive and visually appealing user interfaces. Skilled in HTML, CSS, JavaScript, and responsive web design, with hands-on experience in building projects during self-guided training. Strong communication and problem-solving skills developed in sales, now applied to delivering excellent user experiences in the tech space.</p>
      </div>
      ...
      <div className='section courses'>
        ...
        <ul>
          <li>HTML &amp; CSS &lt;
            <span>Mahara Tech &rarr;
              <a style={colorStyle} href={htmlcss} rel="noreferrer" target='_blank'>Certificate</a>
            </span>
            &gt;
          </li>
          <li>Responsive web design &lt;
            <span>www.freecodecamp.org &rarr; 
              <a style={colorStyle} href='https://freecodecamp.org/certification/fcc3c945485-367e-4e0e-b71a-e5d55ba0ad39/responsive-web-design' rel="noreferrer" target='_blank'>Certificate</a>
            </span>
            &gt;
          </li>
          <li>JavaScript &lt;
            <span>Mahara Tech &rarr;
              <a style={colorStyle} href={javascript} rel="noreferrer" target='_blank'>Certificate</a>
            </span>
            &gt;
          </li>
          <li>JavaScript-ES6 &lt;
            <span>Mahara Tech &rarr;
              <a style={colorStyle} href={es6} rel="noreferrer" target='_blank'>Certificate</a>
            </span>
            &gt;
          </li>
          <li>Javascript algorithms and data structures &lt;
            <span>www.freecodecamp.org &rarr; 
              <a style={colorStyle} href='https://freecodecamp.org/certification/fcc3c945485-367e-4e0e-b71a-e5d55ba0ad39/javascript-algorithms-and-data-structures-v8' rel="noreferrer" target='_blank'> Certificate</a>
            </span>
            &gt;
          </li>
          <li>TypeScript &lt;
            <span>Mahara Tech &rarr; 
              <a style={colorStyle} href={typescript} rel="noreferrer" target='_blank'>Certificate</a>
            </span>
            &gt;
          </li>
          <li>Front end development libraries &lt;
            <span>www.freecodecamp.org &rarr; 
              <a style={colorStyle} href='https://freecodecamp.org/certification/fcc3c945485-367e-4e0e-b71a-e5d55ba0ad39/front-end-development-libraries' rel="noreferrer" target='_blank'>Certificate</a>
            </span>
            &gt;
          </li>
        </ul>
      ...
      <div className='section work-experiance'>
        ...
        <div className='experiance'>
          <h3 className="workExp">Store In-Charge | Retail Sales | Customer Service</h3>
          <h4>
          ...
          <hr></hr>
          <h3 className="workExp">Admin, Accountant Assistant | Cashier</h3>
          ...
          <hr></hr>
          <h3 className="workExp">Sales Representative</h3>
          ...
          <hr></hr>
          <h3 className="workExp">Medical Representative</h3>
