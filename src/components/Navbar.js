...
export default function Navbar({theme, setTheme}) {
  return (
    <div className={theme?'navbar dark':'navbar'}>
      ...
      <div className='navbar-list main-div'>
        <NavLink className={theme?"link black":"link"} to={"/portfolio"}><span className='navbar-list-item'>Home</span>
        </NavLink>
        <NavLink className={theme?"link black":"link"} to={"/projects"}><span className='navbar-list-item'>Projects</span>
        </NavLink>
        <NavLink className={theme?"link black":"link"} to={"/about"}><span className='navbar-list-item'>About</span>
        </NavLink>
      ...
      <div className='navbar-list small-screens'>
        <NavLink className={theme?"link black":"link"} to={"/portfolio"}><span className='navbar-list-item'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
  ...
  <path d="M12 1a2 2 0 0 1 2 2 2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2 2 2 0 0 1-2-2V3a2 2 0 0 1 2-2zM2 12V5a2 2 0 0 1 2-2h9a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1m1-4v5a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V8zm12-1V5a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v2z"/>
        ...
        <NavLink className={theme?"link black":"link"} to={"/about"}>
